...
create or replace view ddm_record_poclain_details as (SELECT individual.uuid                                                                  "Ind.uuid",
...
create or replace view ddm_record_jcb_details as (SELECT individual.uuid                                                                  "Ind.uuid",
     individual.address_id                                                            "Ind.address_id",
     individual.first_name                                                            "Ind.first_name",
     individual.last_name                                                             "Ind.last_name",
     g.name                                                                           "Ind.Gender",
...
create or replace view ddm_baseline_survey as (SELECT individual.uuid                                                                  "Ind.uuid",
  individual.first_name                                                            "Ind.first_name",
  individual.last_name                                                             "Ind.last_name",
  g.name                                                                           "Ind.Gender",
  individual.date_of_birth                                                         "Ind.date_of_birth",
...
create or replace view ddm_endline_survey as (SELECT individual.uuid                                                                        "Ind.uuid",
 individual.first_name                                                                  "Ind.first_name",
 individual.last_name                                                                   "Ind.last_name",
 g.name                                                                                 "Ind.Gender",
 individual.date_of_birth                                                               "Ind.date_of_birth",
...
create or replace view ddm_beneficiary_data as (SELECT individual.uuid                                                                  "Ind.uuid",
   individual.address_id                                                            "Ind.address_id",
   individual.first_name                                                            "Ind.first_name",
   individual.last_name                                                             "Ind.last_name",
   g.name                                                                           "Ind.Gender",
   ...
   programEncounter.observations ->>
   '587bd99d-099e-4574-803f-49d432ab5a84' :: TEXT                                as "Enc.Number of hywa",
   programEncounter.observations ->>
   ...
   programEncounter.observations ->>
   '5cbec7cb-93de-42f2-9fa5-d790adfe4b13' :: TEXT                                as "Enc.Aadhaar ID",
   programEncounter.observations ->>
   'd9ad08ab-63a2-40ae-85f7-a638aa0c780d' :: TEXT                                as "Enc.Landholding according to 8A in acres",
   programEncounter.observations ->>
   '45b4dfb9-2a8f-46cc-9b78-33560c81a16e' :: TEXT                                as "Enc.Village",
   programEncounter.observations ->>
   '74863f01-cf77-4c84-b8e4-5322cc6602ef' :: TEXT                                as "Enc.Mobile number",
   programEncounter.observations ->>
   'd690cffb-cfc9-44f3-ae7e-e658198c17e2' :: TEXT                                as "Enc.Beneficiary name",
   programEncounter.cancel_date_time                                                "EncCancel.cancel_date_time"
...
create or replace view ddm_locations_view as (select vill.id    village_id,
 vill.title village,
 blck.id    block_id,
 blck.title block,
 dist.id    district_id,
